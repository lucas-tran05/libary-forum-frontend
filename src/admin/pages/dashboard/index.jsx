        ...
        <>
          ...
          <Row gutter={[16, 16]} style={{ marginTop: '16px' }}>
            <Col xs={24} lg={14}>
              ...
              <Table columns={userColumns} pagination={false} dataSource={users} rowKey="_id" size={screens.xs ? 'small' : 'middle'} />
            </Col>
            <Col xs={24} lg={10}>
          ...
          <Row style={{ marginTop: '16px' }}>
            <Col span={24}>
              ...
              <Table columns={bookColumns} pagination={false} dataSource={books} rowKey="_id" size={screens.xs ? 'small' : 'middle'} />
            </Col>
          </Row>
        </>
      )}
